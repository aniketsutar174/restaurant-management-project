...
import (
	...
	"log"
	"net/http"
	"restaurent-management-golang/database"
	helper "restaurent-management-golang/helpers"
	"restaurent-management-golang/models"
	"strconv"
	"time"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		password := HashPassword(*user.Passoword)
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		passwordIsValid, msg := VerifyPassword(*user.Passoword, *foundUser.Passoword)
		defer cancel()
